...
**Companies**:  
[Facebook](https://leetcode.com/company/facebook), [Microsoft](https://leetcode.com/company/microsoft), [Amazon](https://leetcode.com/company/amazon), [Google](https://leetcode.com/company/google), [JPMorgan](https://leetcode.com/company/jpmorgan), [Uber](https://leetcode.com/company/uber), [Adobe](https://leetcode.com/company/adobe)
...
class BSTIterator {
    ...
    public BSTIterator(TreeNode root) {
        ...
        index = -1;
        populateTheList(root);
    }
    public void populateTheList(TreeNode root) {
        if (root == null)  return;
        populateTheList(root.left);
        sortedList.add(root.val);
        populateTheList(root.right);
    }
    public int next() {
        return sortedList.get(++index);
    }
    public boolean hasNext() {
        //return false only where the index is at the end index = sortedList.size()-1 => if (index+1) < sortedList.size() => true
