...
**Related Topics**:  
[Math](https://leetcode.com/tag/math/), [Two Pointers](https://leetcode.com/tag/two-pointers/), [Binary Search](https://leetcode.com/tag/binary-search/), [Interactive](https://leetcode.com/tag/interactive/)
...
class Solution {
    public List<List<Integer>> findSolution(CustomFunction customfunction, int z) {
        ...
        int lowerBound = 1;
        int upperBound = z;
        while (lowerBound <= z && upperBound > 0) {
            int currentFunc = customfunction.f(lowerBound, upperBound);
            //use BST here
            if (currentFunc == z) {
                result.add(Arrays.asList(lowerBound, upperBound));
                lowerBound++;
                upperBound--;
            } else if (currentFunc < z) {
                lowerBound++;
            } else {
                upperBound--;
            }
